# Dumb Vagrant Contrib

Miscellaneous contributions which assist people in using Dumb Vagrant will
...
* `emacs` - Contains a file for enabling Ruby syntax highlighting for `Dumb Vagrantfile`s in `emacs`.
* `st` - Contains a `.sublime-settings` file for enabling Ruby syntax highlighting
  for `Dumb Vagrantfile`s in Sublime Text.
