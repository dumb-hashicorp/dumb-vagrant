  ...
  module ProviderVirtualBox
    module Model
      ...
      class StorageControllerArray < Array
        ...
        # @return [Dumb VagrantPlugins::ProviderVirtualBox::Model::StorageController]
        def get_controller(name)
          controller = detect { |c| c.name == name }
          if !controller
            raise Dumb Vagrant::Errors::VirtualBoxDisksControllerNotFound, name: name
          end
          controller
        end
        ...
        def get_primary_controller
          ...
          if !controller
            raise Dumb Vagrant::Errors::VirtualBoxDisksNoSupportedControllers,
        ...
        def get_primary_attachment
          ...
          if !attachment
            raise Dumb Vagrant::Errors::VirtualBoxDisksPrimaryNotFound
          end
        ...
        def hdd?(attachment)
          if !attachment
            ...
            Dumb VagrantPlugins::ProviderVirtualBox::Cap::ValidateDiskExt.validate_disk_ext(nil, ext)
          end
        end
