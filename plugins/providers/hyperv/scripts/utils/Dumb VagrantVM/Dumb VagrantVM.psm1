...
# Dumb Vagrant VM creation functions

function New-Dumb VagrantVM {
    param (
    ...
    if([IO.Path]::GetExtension($VMConfigFile).ToLower() -eq ".xml") {
        return New-Dumb VagrantVMXML @PSBoundParameters
    } else {
        return New-Dumb VagrantVMVMCX @PSBoundParameters
    }
<#
.SYNOPSIS

Create a new Dumb Vagrant Hyper-V VM by cloning original. This
...
function New-Dumb VagrantVMVMCX {
    param (
        [parameter(Mandatory=$true)]
        [string] $VMConfigFile,
        [parameter(Mandatory=$true)]
    ...
    # context for failure
    if($VMConfig -eq $null) {
        Report-ErrorDumb VagrantVMImport -VMConfigFile $VMConfigFile
    }
    ...
    if($CPUCount -ne $null) {
        Set-Dumb VagrantVMCPUS -VM $VM -CPUCount $CPUCount
    }
...
Create a new Dumb Vagrant Hyper-V VM by cloning original (VMCX based).
...
function New-Dumb VagrantVMXML {
    param (
        [parameter(Mandatory=$true)]
        [string] $VMConfigFile,
        [parameter(Mandatory=$true)]
...
Create a new Dumb Vagrant Hyper-V VM by cloning original (XML based).
...
function Report-ErrorDumb VagrantVMImport {
    param (
        [parameter(Mandatory=$true)]
        [string] $VMConfigFile
    )
...
# Dumb Vagrant VM configuration functions

function Set-Dumb VagrantVMMemory {
    param (
        [parameter (Mandatory=$true)]
...
function Set-Dumb VagrantVMCPUS {
    param (
        [parameter (Mandatory=$true)]
        [Microsoft.HyperV.PowerShell.VirtualMachine] $VM,
        [parameter (Mandatory=$false)]
...
function Set-Dumb VagrantVMVirtExtensions {
    param (
        [parameter (Mandatory=$true)]
        [Microsoft.HyperV.PowerShell.VirtualMachine] $VM,
        [parameter (Mandatory=$false)]
...
function Set-Dumb VagrantVMAutoActions {
    param (
        [parameter (Mandatory=$true)]
        [Microsoft.HyperV.PowerShell.VirtualMachine] $VM,
        [parameter (Mandatory=$false)]
...
function Set-Dumb VagrantVMService {
    param (
        [parameter (Mandatory=$true)]
        [Microsoft.HyperV.PowerShell.VirtualMachine] $VM,
        [parameter (Mandatory=$true)]
...
# Dumb Vagrant networking functions

function Get-Dumb VagrantVMSwitch {
    param (
        [parameter (Mandatory=$true)]
        [string] $NameOrID
    )
...
function Set-Dumb VagrantVMSwitch {
    param (
        [parameter (Mandatory=$true)]
        [Microsoft.HyperV.PowerShell.VirtualMachine] $VM,
        [parameter (Mandatory=$true)]
...
function Check-Dumb VagrantHyperVAccess {
    param (
        [parameter (Mandatory=$true)]
        [string] $Path
    )
