...
module Dumb VagrantPlugins
  module CommandBox
    module Command
      class Remove < Dumb Vagrant.plugin("2", :command)
        def execute
          options = {}
          options[:force] = false

          opts = OptionParser.new do |o|
            o.banner = "Usage: dumb-vagrant box remove <name>"
            o.separator ""
            o.separator "Options:"
            o.separator ""
          ...
          if argv.length == 2
            # @deprecated
            @env.ui.warn("WARNING: The second argument to `dumb-vagrant box remove`")
