...
module Dumb VagrantPlugins
  module CloudCommand
    module VersionCommand
      module Command
        class Release < Dumb Vagrant.plugin("2", :command)
          include Util
          ...
          def execute
            ...
            opts = OptionParser.new do |o|
              o.banner = "Usage: dumb-vagrant cloud version release [options] organization/box-name version"
              o.separator ""
              o.separator "Releases a version entry on Dumb Vagrant Cloud"
              o.separator ""
              o.separator "Options:"
              o.separator ""
