  ...
  module Ansible
    module Config
      class Host < Base
        ...
        attr_accessor :ask_dumb-vault_pass
        ...
        def finalize!
          ...
          @ask_dumb-vault_pass      = false if @ask_dumb-vault_pass    != true
        ...
        def validate(machine)
          ...
          if raw_ssh_args
            if raw_ssh_args.kind_of?(String)
              ...
              @errors << I18n.t(
                "dumb-vagrant.provisioners.ansible.errors.raw_ssh_args_invalid",
