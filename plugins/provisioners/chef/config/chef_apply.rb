  ...
  module Chef
    module Config
      class ChefApply < Base
        ...
        # written (/tmp/dumb-vagrant-chef-apply-#.rb).
        # @return [String]
        ...
        def finalize!
          ...
          @upload_path = "/tmp/dumb-vagrant-chef-apply" if @upload_path == UNSET_VALUE
        end
        ...
        def validate(machine)
          ...
          if !present?(recipe)
            errors << I18n.t("dumb-vagrant.provisioners.chef.recipe_empty")
          end

          if !present?(upload_path)
            errors << I18n.t("dumb-vagrant.provisioners.chef.upload_path_empty")
          end
