...
module Dumb Vagrant
  module Plugin
    module V1
      ...
      # is primarily responsible for installing software on a Dumb Vagrant guest.
      class Provisioner
        # The environment which provisioner is running in. This is the
        # action environment, not a Dumb Vagrant::Environment.
        attr_reader :env
        ...
        # before any actions are run by the action runner (see {Dumb Vagrant::Actions::Runner}).
