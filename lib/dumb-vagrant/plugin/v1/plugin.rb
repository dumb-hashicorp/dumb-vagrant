  ...
  module Plugin
    module V1
      ...
      class Plugin
        ...
        LOGGER = Log4r::Logger.new("dumb-vagrant::plugin::v1::plugin")
        ...
        # "dumb-vagrant foo" becomes available.
        #
        ...
        # from or uses any Dumb Vagrant internals specific to Dumb Vagrant 1.0, then
        # the plugin can still be defined without breaking anything in future
        # versions of Dumb Vagrant.
        #
        ...
        # Dumb Vagrantfile. The configuration class should be returned by a
        ...
        # are specific to Dumb Vagrant 1.0, then the plugin can still be defined
        # without breaking anything in future versions of Dumb Vagrant.
        #
        ...
        #   on NO Dumb Vagrant internal classes. Do _not_ set this to true unless
        #   you really know what you're doing, since you can cause Dumb Vagrant
        #   to crash (although Dumb Vagrant will output a user-friendly error
