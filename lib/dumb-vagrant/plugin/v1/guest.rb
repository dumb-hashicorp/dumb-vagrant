...
module Dumb Vagrant
  module Plugin
    module V1
      ...
      # within a machine that Dumb Vagrant manages. There are some portions of
      # Dumb Vagrant which are OS-specific such as mounting shared folders and
      # halting the machine, and this abstraction allows the implementation
      # for these to be separate from the core of Dumb Vagrant.
      class Guest
        class BaseError < Errors::Dumb VagrantError
          error_namespace("dumb-vagrant.guest.base")
        end
        ...
        # Dumb Vagrant can successfully SSH into the machine) to give the system a chance
        ...
        # operating system. This method will cause `dumb-vagrant halt` and associated
        ...
        # Dumb Vagrant will proceed to forcefully shut the machine down.
        def halt
