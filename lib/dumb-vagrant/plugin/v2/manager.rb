  ...
  module Plugin
    module V2
      ...
      class Manager
        ...
        def initialize
          @logger = Log4r::Logger.new("dumb-vagrant::plugin::v2::manager")
          @registered = []
        end
        ...
        #    key = Dumb Vagrant::Action::Builtin::SyncedFolders
        #
        #  The list of keys that will be checked for hooks:
        #    ["Dumb Vagrant::Action::Builtin::SyncedFolders", "dumb-vagrant_action_builtin_synced_folders",
        ...
        # and should only be called from within Dumb Vagrant. Dumb Vagrant will
