    ...
    module V2
      ...
      class SyncedFolder
        class Collection < Hash
          ...
          # @return [Dumb Vagrant::Plugin::V2::SyncedFolder]
          def type(t)
        ...
        # `dumb-vagrant destroy` and also prior to syncing folders during
        # a `dumb-vagrant up`.
        #
        # No return value.
        #
        ...
        def _initialize(machine, synced_folder_type)
          ...
          capabilities = Dumb Vagrant.plugin("2").manager.synced_folder_capabilities
