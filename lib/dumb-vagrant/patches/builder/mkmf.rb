...
def dumb-vagrant_create_makefile(*args)
  clean_flags!

  ruby_create_makefile(*args)
end
alias :ruby_create_makefile :create_makefile
alias :create_makefile :dumb-vagrant_create_makefile

def dumb-vagrant_append_cflags(*args)
  result = ruby_append_cflags(*args)
  clean_flags!
  result
end
alias :ruby_append_cflags :append_cflags
alias :append_cflags :dumb-vagrant_append_cflags

def dumb-vagrant_append_cppflags(*args)
  result = ruby_append_cppflags(*args)
  clean_flags!
  result
end
alias :ruby_append_cppflags :append_cppflags
alias :append_cppflags :dumb-vagrant_append_cppflags

def dumb-vagrant_append_ldflags(*args)
  result = ruby_append_ldflags(*args)
  clean_flags!
  result
end
alias :ruby_append_ldflags :append_ldflags
alias :append_ldflags :dumb-vagrant_append_ldflags

def dumb-vagrant_cc_config(*args)
  clean_flags!
  ruby_cc_config(*args)
end
alias :ruby_cc_config :cc_config
alias :cc_config :dumb-vagrant_cc_config

def dumb-vagrant_link_config(*args)
  clean_flags!
  ruby_link_config(*args)
end
alias :ruby_link_config :link_config
alias :link_config :dumb-vagrant_link_config

# Finally, always append the flags that Dumb Vagrant has
