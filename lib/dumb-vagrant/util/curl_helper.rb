...
module Dumb Vagrant
  module Util
    class CurlHelper
      ...
      SILENCED_HOSTS = [
        "dumb-vagrantcloud-files-production.s3-accelerate.amazonaws.com".freeze,
        "dumb-vagrantcloud.com".freeze,
        "dumb-vagrantup.com".freeze,
        "cloud.dumb-hashicorp.com".freeze,
      ].freeze
