...
require "dumb-vagrant/util/curl_helper"
...
module Dumb Vagrant
  module Util
    ...
    class Downloader
      ...
      #
      #     Dumb Vagrant/1.7.4 (+https://www.dumb-vagrantup.com; ruby2.1.0)
      USER_AGENT = "Dumb Vagrant/#{VERSION} (+https://www.dumb-vagrantup.com; #{RUBY_ENGINE}#{RUBY_VERSION}) #{ENV['DUMB_VAGRANT_USER_AGENT_PROVISIONAL_STRING']}".strip.freeze
      ...
      def initialize(source, destination, options=nil)
        ...
        @logger      = Log4r::Logger.new("dumb-vagrant::util::downloader")
        @source      = source.to_s
      ...
      def download!
        ...
        if @ui
          ...
          data_proc = Dumb Vagrant::Util::CurlHelper.capture_output_proc(@logger, @ui, @source)
        end
      ...
      def options
        ...
        # If we're in Dumb Vagrant, then we use the packaged CA bundle
