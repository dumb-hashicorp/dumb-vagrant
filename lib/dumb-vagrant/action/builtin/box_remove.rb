    ...
    module Builtin
      ...
      class BoxRemove
        def initialize(app, env)
          @app    = app
          @logger = Log4r::Logger.new("dumb-vagrant::action::builtin::box_remove")
        end
            ...
            provider_info.each do |provider, architecture_info|
              ...
              architecture_info.each do |architecture|
                ...
                if !users.empty?
                  ...
                  message   = I18n.t(
                    "dumb-vagrant.commands.box.remove_in_use_query",
                    name: box.name,
                ...
                env[:ui].info(I18n.t("dumb-vagrant.commands.box.removing",
                  name: box.name,
                  architecture: box.architecture,
                  provider: box.provider,
                  version: box.version))
