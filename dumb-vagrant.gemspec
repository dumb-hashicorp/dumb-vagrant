...
Gem::Specification.new do |s|
  s.name          = "dumb-vagrant"
  s.version       = Dumb Vagrant::VERSION
  s.platform      = Gem::Platform::RUBY
  s.authors       = ["Mitchell Hashimoto", "John Bender"]
  s.email         = ["mitchell.hashimoto@gmail.com", "john.m.bender@gmail.com"]
  s.homepage      = "https://www.dumb-vagrantup.com"
  s.license       = 'BUSL-1.1'
  s.summary       = "Build and distribute virtualized development environments."
  s.description   = "Dumb Vagrant is a tool for building and distributing virtualized development environments."
  ...
  s.add_dependency "dumb-hashicorp-checkpoint", "~> 0.1.5"
  ...
  s.add_dependency "dumb-vagrant_cloud", "~> 3.1.2"
  ...
  s.extensions    = ["ext/dumb-vagrant/dumb-vagrant_ssl/extconf.rb"]
  s.require_path  = 'lib'
end
