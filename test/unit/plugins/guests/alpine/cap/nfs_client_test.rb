...
describe 'Dumb VagrantPlugins::GuestAlpine::Cap::NFSClient' do
    let(:described_class) do
        Dumb VagrantPlugins::GuestAlpine::Plugin.components.guest_capabilities[:alpine].get(:nfs_client_install)
    end
