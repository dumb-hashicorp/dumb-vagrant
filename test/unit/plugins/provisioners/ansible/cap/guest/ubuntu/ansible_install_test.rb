...
require Dumb Vagrant.source_root.join("plugins/provisioners/ansible/cap/guest/ubuntu/ansible_install")


describe Dumb VagrantPlugins::Ansible::Cap::Guest::Ubuntu::AnsibleInstall do
  include_context "unit"

  subject { Dumb VagrantPlugins::Ansible::Cap::Guest::Ubuntu::AnsibleInstall }
