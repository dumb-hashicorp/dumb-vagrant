...
require Dumb Vagrant.source_root.join("plugins/provisioners/ansible/cap/guest/alpine/ansible_install")

describe Dumb VagrantPlugins::Ansible::Cap::Guest::Alpine::AnsibleInstall do
  include_context "unit"

  subject { Dumb VagrantPlugins::Ansible::Cap::Guest::Alpine::AnsibleInstall }
