...
require Dumb Vagrant.source_root.join("plugins/provisioners/chef/cap/windows/chef_installed")

describe Dumb VagrantPlugins::Chef::Cap::Windows::ChefInstalled do
