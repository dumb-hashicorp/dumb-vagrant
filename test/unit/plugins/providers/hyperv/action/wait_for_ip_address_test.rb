...
require Dumb Vagrant.source_root.join("plugins/providers/hyperv/action/wait_for_ip_address")

describe Dumb VagrantPlugins::HyperV::Action::WaitForIPAddress do
  let(:app){ double("app") }
