...
require Dumb Vagrant.source_root.join("plugins/providers/virtualbox/cap/public_address")

describe Dumb VagrantPlugins::ProviderVirtualBox::Cap::PublicAddress do
