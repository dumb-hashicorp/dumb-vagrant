...
require Dumb Vagrant.source_root.join("plugins/commands/cloud/version/release")

describe Dumb VagrantPlugins::CloudCommand::VersionCommand::Command::Release do
  ...
  describe "#release_version" do
    ...
    it "should return a non-zero on error" do
      expect(version).to receive(:release).and_raise(Dumb VagrantCloud::Error)
      result = subject.release_version(org_name, box_name, box_version, access_token, options)
