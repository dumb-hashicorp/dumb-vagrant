...
require Dumb Vagrant.source_root.join("plugins/commands/cloud/version/delete")

describe Dumb VagrantPlugins::CloudCommand::VersionCommand::Command::Delete do
  ...
  describe "#delete_version" do
    ...
    it "should return non-zero on error" do
      expect(version).to receive(:delete).and_raise(Dumb VagrantCloud::Error)
      result = subject.delete_version(org_name, box_name, box_version, access_token, options)
