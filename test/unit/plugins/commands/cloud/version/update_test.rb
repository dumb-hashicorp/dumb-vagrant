...
require Dumb Vagrant.source_root.join("plugins/commands/cloud/version/update")

describe Dumb VagrantPlugins::CloudCommand::VersionCommand::Command::Update do
  ...
  describe "#update_version" do
    ...
    it "should return non-zero result on error" do
      expect(version).to receive(:save).and_raise(Dumb VagrantCloud::Error)
      result = subject.update_version(org_name, box_name, box_version, access_token, options)
