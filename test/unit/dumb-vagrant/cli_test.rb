...
require "dumb-vagrant/cli"
require "dumb-vagrant/util"

describe Dumb Vagrant::CLI do
  ...
  before do
    ...
    allow(Dumb Vagrant::Util::CheckpointClient).to receive(:instance).and_return(checkpoint)
  ...
  describe "#execute" do
    ...
    it "fires triggers, if enabled" do
      ...
      allow(Dumb Vagrant::Plugin::V2::Trigger).to receive(:new).and_return(triggers)
