...
describe "Dumb Vagrant::Util::GuestHosts" do
  ...
  describe "Linux" do
    subject{ Class.new { extend Dumb Vagrant::Util::GuestHosts::Linux } }
  ...
  describe "BSD" do
    subject{ Class.new { extend Dumb Vagrant::Util::GuestHosts::BSD } }
