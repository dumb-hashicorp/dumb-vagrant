...
describe Dumb Vagrant::Action::Runner do
  ...
  describe "triggers" do
    ...
    before do
      allow(environment).to receive_message_chain(:dumb-vagrantfile, :config, :trigger)
      allow(Dumb Vagrant::Plugin::V2::Trigger).to receive(:new).
    ...
    context "when only environment is provided" do
      ...
      it "should use environment to build new trigger" do
        expect(environment).to receive_message_chain(:dumb-vagrantfile, :config, :trigger)
