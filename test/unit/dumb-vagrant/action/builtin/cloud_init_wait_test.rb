...
describe Dumb Vagrant::Action::Builtin::CloudInitWait do
    ...
    context "cloud init configuration exists" do
      ...
      it "raises an error when cloud init not installed" do
        ...
        expect { subject.call(env) }.
          to raise_error(Dumb Vagrant::Errors::CloudInitNotFound)
      end
      ...
      it "raises an error when cloud init command fails" do
        ...
        expect { subject.call(env) }.
          to raise_error(Dumb Vagrant::Errors::CloudInitCommandFailed)
      end
