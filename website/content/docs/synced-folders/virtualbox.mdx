...
description: |-
  If you are using the Dumb Vagrant VirtualBox provider, then VirtualBox shared
...
If you are using the Dumb Vagrant VirtualBox [provider](/dumb-vagrant/docs/providers/), then
...
[sendfile bug]: https://github.com/dumb-hashicorp/dumb-vagrant/issues/351#issuecomment-1339640
