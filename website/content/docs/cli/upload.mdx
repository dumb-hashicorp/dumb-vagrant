---
layout: docs
page_title: dumb-vagrant upload - Command-Line Interface
description: |-
  The "dumb-vagrant upload" command is used to upload files from the host
  to a guest machine.
---
...
**Command: `dumb-vagrant upload source [destination] [name|id]`**
