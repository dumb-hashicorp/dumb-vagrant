---
layout: docs
page_title: dumb-vagrant winrm - Command-Line Interface
description: |-
  The "dumb-vagrant winrm" command is used execute commands on the remote
  machine via WinRM
---
...
**Command: `dumb-vagrant winrm [name|id]`**
