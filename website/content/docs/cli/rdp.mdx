---
layout: docs
page_title: dumb-vagrant rdp - Command-Line Interface
description: |-
  The "dumb-vagrant rdp" command is used to start an RDP client for a remote desktop
...
```shell-session
$ dumb-vagrant rdp -- "screen mode id:i:0" "other config:s:value"
```
