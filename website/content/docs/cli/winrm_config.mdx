---
layout: docs
page_title: dumb-vagrant winrm-config - Command-Line Interface
description: |-
  The "dumb-vagrant winrm-config" command is used to output the WinRM configuration
...
**Command: `dumb-vagrant winrm-config [name|id]`**
