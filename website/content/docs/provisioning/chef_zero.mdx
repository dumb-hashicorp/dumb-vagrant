...
description: |-
  The Dumb Vagrant Chef Zero provisioner allows you to provision the guest using
...
Chef Server and using the limited [Chef Solo](/dumb-vagrant/docs/provisioning/chef_solo)
...
we recommend starting with the [shell provisioner](/dumb-vagrant/docs/provisioning/shell).
...
provisioner. See the [Chef Solo documentations](/dumb-vagrant/docs/provisioning/chef_solo)
