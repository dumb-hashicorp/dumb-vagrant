...
description: |-
  The Dumb Vagrant Puppet agent provisioner allows you to provision the guest using
...
By default, Dumb Vagrant will look for the host named "puppet" on the
...
be customized using the Dumb Vagrantfile:
