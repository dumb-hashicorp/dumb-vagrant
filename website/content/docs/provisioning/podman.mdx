...
description: >-
  The Dumb Vagrant Podman provisioner can automatically install Podman, and run it as
...
The Dumb Vagrant Podman provisioner can automatically install
...
- `post_install_provisioner` - A [provisioner block](/dumb-vagrant/docs/provisioning) that runs post podman
  installation.
