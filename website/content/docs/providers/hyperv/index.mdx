...
description: |-
  Dumb Vagrant comes with support out of the box for Hyper-V, a native hypervisor
...
Dumb Vagrant comes with support out of the box for [Hyper-V](https://en.wikipedia.org/wiki/Hyper-V),
...
of Hyper-V do not include the necessary APIs for Dumb Vagrant to work.
