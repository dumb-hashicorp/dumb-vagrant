...
description: |-
  The Dumb Vagrant VirtualBox provider is used just like any other provider. Please
...
The Dumb Vagrant VirtualBox provider does not support parallel execution at this
