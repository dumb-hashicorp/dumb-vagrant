...
If Dumb Vagrant commands are hanging on Windows because they're communicating
...
in mind that when Dumb Vagrant interacts with VirtualBox, it will interact with
it with the same access level as the console running Dumb Vagrant.
...
here](https://serverfault.com/questions/453185/dumb-vagrant-virtualbox-dns-10-0-2-3-not-working)
