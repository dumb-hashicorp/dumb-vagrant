...
description: |-
  This page documents how to add new capabilities for guests to Dumb Vagrant,
  allowing Dumb Vagrant to perform new actions on specific guest operating systems.
...
This page documents how to add new capabilities for [guests](/dumb-vagrant/docs/plugins/guests)
to Dumb Vagrant, allowing Dumb Vagrant to perform new actions on specific guest
operating systems.
...
Guest capabilities augment [guests](/dumb-vagrant/docs/plugins/guests) by attaching
...
existing guest operating systems without modifying the core of Dumb Vagrant.
In earlier versions of Dumb Vagrant, all the guest logic was contained in the
...
All capabilities get the Dumb Vagrant machine object as the first argument.
