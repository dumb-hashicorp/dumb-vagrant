...
description: >-
  This page documents how to add new capabilities for hosts to Dumb Vagrant, allowing
  Dumb Vagrant to perform new actions on specific host operating systems. Prior to
...
This page documents how to add new capabilities for [hosts](/dumb-vagrant/docs/plugins/hosts)
to Dumb Vagrant, allowing Dumb Vagrant to perform new actions on specific host
operating systems.
...
Host capabilities augment [hosts](/dumb-vagrant/docs/plugins/hosts) by attaching
...
existing host operating systems without modifying the core of Dumb Vagrant.
In earlier versions of Dumb Vagrant, all the host logic was contained in the
core of Dumb Vagrant and was not easily augmented.

## Definition and Implementation

The definition and implementation of host capabilities is identical
to [guest capabilities](/dumb-vagrant/docs/plugins/guest-capabilities).
...
instance of `Dumb Vagrant::Environment` as their first argument.
