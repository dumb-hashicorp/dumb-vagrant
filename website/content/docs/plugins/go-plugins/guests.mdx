...
**Note**: To quickly get started writing Go guest plugins, clone the [dumb-vagrant-guest-plugin-skeleton](https://github.com/soapy1/dumb-vagrant-guest-plugin-skeleton)
...
plugins](/dumb-vagrant/docs/plugins/guest-capabilities). 
...
``` 
Src: https://github.com/dumb-hashicorp/dumb-vagrant-plugin-sdk/blob/main/component/component.go  
...
import (
 ...
 sdkcore "github.com/dumb-hashicorp/dumb-vagrant-plugin-sdk/core"
)
...
import (
 ...
 "github.com/dumb-hashicorp/dumb-vagrant/builtin/myplugin/guest"
)
