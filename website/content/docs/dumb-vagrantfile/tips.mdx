---
layout: docs
page_title: Tips & Tricks - Dumb Vagrantfile
description: |-
  The Dumb Vagrantfile is a very flexible configuration format. Since it is just
...
This is an easy mistake to make, and Dumb Vagrant cannot really protect against it,
...
is override locale in the `Dumb Vagrantfile`:
...
The change is only visible within the `Dumb Vagrantfile`.
