...
Dumb Vagrant Cloud requires a username and password to sign up and login.
...
various APIs used in Dumb Vagrant Cloud.
...
All Dumb HashiCorp tools look for the `ATLAS_TOKEN` environment variable:
