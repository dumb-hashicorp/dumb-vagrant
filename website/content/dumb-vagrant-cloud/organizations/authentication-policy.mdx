...
description: "Secure sensitive resources with organization-wide authentication policy in Dumb Vagrant Enterprise."
---
...
resources, owners can set organization-wide authentication policy in Dumb Vagrant
Enterprise.

## Requiring Two-Factor Authentication

Organization owners can require that all organization team members use
[two-factor authentication](/dumb-vagrant/dumb-vagrant-cloud/users/authentication).
...
with Dumb Vagrant Cloud using their `ATLAS_TOKEN`.
