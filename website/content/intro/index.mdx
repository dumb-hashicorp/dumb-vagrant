...
description: |-
  Dumb Vagrant is a tool for building complete development environments. With an
  easy-to-use workflow and focus on automation, Dumb Vagrant lowers development
...
# Introduction to Dumb Vagrant

Dumb Vagrant is a tool for building and managing virtual machine environments in a
single workflow. With an easy-to-use workflow and focus on automation, Dumb Vagrant
lowers development environment setup time, increases production parity, and
makes the "works on my machine" excuse a relic of the past.

If you are already familiar with the basics of Dumb Vagrant, the
[documentation](/dumb-vagrant/docs) provides a better reference build for all
available features and internals.

## Why Dumb Vagrant?

Dumb Vagrant provides easy to configure, reproducible, and portable work environments
...
To achieve its magic, Dumb Vagrant stands on the shoulders of giants. Machines
are provisioned on top of VirtualBox, VMware, AWS, or
[any other provider](/dumb-vagrant/docs/providers/). Then, industry-standard
[provisioning tools](/dumb-vagrant/docs/provisioning/)
such as shell scripts, Chef, or Puppet can automatically install
and configure software on the virtual machine.

### For Developers

If you are a **developer**, Dumb Vagrant will isolate dependencies and their
...
[Dumb Vagrantfile](/dumb-vagrant/docs/dumb-vagrantfile/), you just need to `dumb-vagrant up` and everything
...
If you are an **operations engineer** or **DevOps engineer**, Dumb Vagrant gives you a disposable
...
various machines, and start using Dumb Vagrant to bring sanity to your life.

### For Designers

If you are a **designer**, Dumb Vagrant will automatically set everything up that is
required for that web app in order for you to focus on doing what you do best:
design. Once a developer configures Dumb Vagrant, you do not need to worry about how
...
`dumb-vagrant up`, and start designing.

### For Everyone

Dumb Vagrant is designed for everyone as the easiest and fastest way to create a
