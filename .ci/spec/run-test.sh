...
echo "Running dumb-vagrant spec tests..."
# Need to make memory customizable for windows hosts
wrap_stream packet-exec run "dumb-vagrant provision" \
                "Dumb Vagrant Acceptance testing command failed"

echo "Finished dumb-vagrant spec tests"
